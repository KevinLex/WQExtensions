...
+ (instancetype)wq_colorWithHex:(uint32_t)hex {
    ...
    return [self wq_colorWithRed:r green:g blue:b];
}

+ (instancetype)wq_randomColor {
    return [UIColor wq_colorWithRed:arc4random_uniform(256) green:arc4random_uniform(256) blue:arc4random_uniform(256)];
}
