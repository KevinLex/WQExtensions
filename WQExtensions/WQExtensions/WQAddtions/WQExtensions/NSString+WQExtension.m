 ...
 *  判断是否包含某字符串
 */
- (BOOL)wq_isContainsSubString:(NSString *)subString{
...
/**
 ...
 @return 高度
 */
- (CGFloat)wq_getMaxHeightWithWidth:(CGFloat)width Font:(CGFloat)fontSize{
...
/**
 ...
 @return 宽度
 */
- (CGFloat)wq_getMaxWidthWithHeight:(CGFloat)height Font:(CGFloat)fontSize{
...
/**
 ...
 @return 宽高
 */
- (CGSize)wq_getSizeWithWidth:(CGFloat)width Height:(CGFloat)height Font:(CGFloat)fontSize{
 ...
 *  @return 截取后的字符串
 */
- (NSString *)wq_cutByteWithNSStingByeBytesCount:(int)count
{
 ...
 *  @return 加密号码
 */
- (NSString *)wq_changeMobileNumber{
...
- (NSString *)wq_getPastTimeStringWithFormate:(NSString *)formate
{
...
- (NSString *)wq_hmacMD5StringWithKey:(NSString *)key {
...
- (NSString *)wq_hmacSHA1StringWithKey:(NSString *)key {
    const char *keyData = key.UTF8String;
    const char *strData = self.UTF8String;
    uint8_t buffer[CC_SHA1_DIGEST_LENGTH];
...
- (NSString *)wq_hmacSHA256StringWithKey:(NSString *)key {
    const char *keyData = key.UTF8String;
    const char *strData = self.UTF8String;
    uint8_t buffer[CC_SHA256_DIGEST_LENGTH];
...
- (NSString *)wq_hmacSHA512StringWithKey:(NSString *)key {
    const char *keyData = key.UTF8String;
    const char *strData = self.UTF8String;
    uint8_t buffer[CC_SHA512_DIGEST_LENGTH];
